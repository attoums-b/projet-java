...
public class JaugeNaturel {
  ...
  public JaugeNaturel(int valeurMin, int valeurActuelle , int valeurMax) {
	  if(valeurMin > valeurMax) {
		  throw new IllegalArgumentException("la valeur minimale est inférieure à la valeur maximale!!");  
		  }
     ...
     */
    // présence d'erreur dans le constructeur
    // modification imminente de celui ci 
  }
